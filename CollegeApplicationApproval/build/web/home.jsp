    ...
    <body>
           ...
           <div class="div1">
                ...
                <center>       <h1 style="font-family: cursive;text-shadow: 1px 1px 1px white;color: palegoldenrod;float:left;margin-left: 300;">COLLEGE APPLICATION APPROVAL</h1></center>
                 <nav style="float:right;">
                     ...
                     <p style="background-color:none; margin-top: 20px;color:whitesmoke;text-decoration:none;font-size:30px;margin-left:40px;padding:16px 15px;border: 1px;border-radius:60px">
     ...
     <div class="div2">
               <nav>
                   ...
                   <a href="apply.html">collegese for you</a>
